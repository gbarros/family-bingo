...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] bg-crimson-light/10 rounded-full blur-2xl -z-1" />
      ...
      <div className="relative z-10 max-w-4xl w-full">
        ...
        <div className="text-center space-y-4 mb-16 animate-in fade-in slide-in-from-top-12 duration-1000">
          <h1 className="text-6xl md:text-8xl font-display font-bold text-shimmer tracking-tight leading-tight">
            BINGO EM FAMÍLIA
          </h1>
          ...
          <div className="flex items-center justify-center gap-4 py-6">
            ...
            <div className="absolute top-0 right-0 p-4">
               <span className="text-xs font-mono text-ivory/50 uppercase tracking-widest bg-ivory/5 border border-ivory/10 px-3 py-1 rounded-full">
        ...
        <div className={`grid ${!isP2P ? 'md:grid-cols-2' : 'grid-cols-1 max-w-lg mx-auto'} gap-8 px-4`}>
          ...
          <Link href="/play" className="group h-full">
            <div className="card-elevated-lg sheen h-full p-8 rounded-3xl bg-cocoa-light/25 backdrop-blur-xl border border-ivory/10 hover:border-gold-light/40 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between group overflow-hidden relative">
              ...
              <div className="relative z-10 space-y-4">
                <div className="w-16 h-16 rounded-2xl bg-ivory/10 ring-1 ring-ivory/20 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-500">
                  👤
                </div>
          ...
          {isP2P ? (
            ...
            <Link href="/manager" className="group block">
              <div className="card-elevated-lg sheen h-full p-8 rounded-3xl bg-cocoa-light/25 backdrop-blur-xl border border-ivory/10 hover:border-gold-light/40 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between group overflow-hidden relative">
                <div className="relative z-10 space-y-4">
                  <div className="w-16 h-16 rounded-2xl bg-gold-light/20 ring-1 ring-gold/30 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-500">
                    ☁️
                  </div>
                  <div>
                    <h2 className="text-3xl font-display font-bold text-ivory group-hover:text-gold-light transition-colors flex items-center gap-2">
        ...
        <div className="mt-20 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
          <p className="text-ivory/40 text-sm italic tracking-wide">
            "Comece o ano novo com alegria e diversão em família."
          </p>
        </div>
      </div>
    </div>
